...
exec java -Xms50m -Xmx250m -Djgroups.bind_addr=$MY_IP_ADDR -Djava.net.preferIPv4Stack=true -cp ../build/libs/jgroups-tester-1.0-SNAPSHOT-all.jar EventTesterKt | addtime >> localhost.txt 2>&1
